    ...
    void insertRecords(char *arqentrada, int n); //insere registros no arquivo de entrada
    void updateRecords(char *arqentrada, int n); //atualiza registros no arquivo de entrada
#endif
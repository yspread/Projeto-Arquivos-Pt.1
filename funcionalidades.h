    ...
    void filterRecords(); //função para imprimir as informações do arquivo de entrada porém com um filtro por campo
    void removeRecords(); //remove logicamente registros do arquivo de entrada
